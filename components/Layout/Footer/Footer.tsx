      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div className="flex flex-col gap-4 md:flex-row">
            ...
            {/* <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-cream transition hover:text-cream/75"
                >
          ...
          <div className="text-center sm:text-left">
            <p className="text-lg font-medium text-cream">Nama Kelompok</p>
            <ul className="mt-8 space-y-4 text-sm">
              <li>
                <a
                  className="flex flex-col flex-wrap md:max-h-[300px] text-left gap-1.5"
                  href="/"
                >
                  {namaKelompok.map((e, i) => (
                    <span key={i} className="text-background">
                      {e}
                    </span>
                  ))}
                </a>
